...
{
    /// <summary>
    /// 複数の子要素を含むインライン要素を表します。
    /// </summary>
	public class CompositeExpression : WikiExpression
    {
        /// <summary>
        /// 現在の要素に含まれる子要素を取得または設定します。
        /// </summary>
		public IList<WikiExpression> Children { get; set; }

        /// <summary>
        /// 含まれる子要素を指定して、<see cref="CompositeExpression"/> の新しいインスタンスを初期化します。
        /// </summary>
        /// <param name="children">含まれる子要素。</param>
		public CompositeExpression(IList<WikiExpression> children) =>
